    ...
    <section id="contactPage">
      <div id="contact">
        ...
        <form className="contactForm" ref={form} onSubmit={sendEmail}>
          ...
          <div className="links">
            <a href="https://www.linkedin.com/in/geerthanah-mathivathanan-b21aaa201?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
              <img src={lin} alt="Linkedin" className="link" />
            </a>
            <a href="https://github.com/geerthanah">
              <img src={git} alt="GitHub" className="link" />
            </a>
            <a href="https://www.instagram.com/geerthanah_m/">
