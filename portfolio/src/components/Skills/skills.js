...
const Skills = () =>{
    return (
        <section id='skills'>
            ...
            <span className='skillDesc'>An undergraduate student studying software engineering is proficient in Python and Java programming languages and is knowledgeable with agile and scrum methodologies. They exhibit excellent communication, teamwork, and time management skills in addition to excelling in problem-solving, algorithm design, and debugging. </span>
